...
import { getTimeString } from "../utils/hepler.mjs";
import { HOME_INSTRUCTION, PROXY_INSTRUCTION } from "./code.mjs";
const think_token = process.env.THINK_TOKEN || 'thinkt';
const use_native_thinking = 'true' === process.env.NATIVE_THINKING;
const bypass_native_thinking = 'bypass' === process.env.NATIVE_THINKING;
...
const mcp_functions = `
{"type": "function", "name": "LinkReader", "description": "\u{8FD9}\u{662F}\u{4E00}\u{4E2A}\u{94FE}\u{63A5}\u{6D4F}\u{89C8}\u{5DE5}\u{5177}\u{FF0C}\u{53EF}\u{4EE5}\u{6253}\u{5F00}\u{94FE}\u{63A5}\u{FF08}\u{53EF}\u{4EE5}\u{662F}\u{7F51}\u{9875}\u{3001}pdf\u{7B49}\u{FF09}\u{5E76}\u{6839}\u{636E}\u{9700}\u{6C42}\u{63CF}\u{8FF0}\u{6C47}\u{603B}\u{9875}\u{9762}\u{4E0A}\u{7684}\u{6240}\u{6709}\u{76F8}\u{5173}\u{4FE1}\u{606F}\u{3002}\u{5EFA}\u{8BAE}\u{5BF9}\u{6240}\u{6709}\u{6709}\u{4EF7}\u{503C}\u{7684}\u{94FE}\u{63A5}\u{90FD}\u{8C03}\u{7528}\u{8BE5}\u{5DE5}\u{5177}\u{6765}\u{83B7}\u{53D6}\u{4FE1}\u{606F}\u{FF0C}\u{6709}\u{4EF7}\u{503C}\u{7684}\u{94FE}\u{63A5}\u{5305}\u{62EC}\u{4F46}\u{4E0D}\u{9650}\u{4E8E}\u{5982}\u{4E0B}\u{51E0}\u{79CD}\u{FF1A}1.\u{4EFB}\u{52A1}\u{4E2D}\u{660E}\u{786E}\u{63D0}\u{4F9B}\u{7684}\u{7F51}\u{5740}\u{FF0C}2.\u{641C}\u{7D22}\u{7ED3}\u{679C}\u{63D0}\u{4F9B}\u{7684}\u{5E26}\u{6709}\u{76F8}\u{5173}\u{6458}\u{8981}\u{7684}\u{7F51}\u{5740}\u{FF0C}3. \u{4E4B}\u{524D}\u{8C03}\u{7528}LinkReader\u{8FD4}\u{56DE}\u{7684}\u{5185}\u{5BB9}\u{4E2D}\u{5305}\u{542B}\u{7684}\u{4E14}\u{5224}\u{65AD}\u{53EF}\u{80FD}\u{542B}\u{6709}\u{6709}\u{7528}\u{4FE1}\u{606F}\u{7684}\u{7F51}\u{5740}\u{3002}\u{8BF7}\u{5C3D}\u{91CF}\u{907F}\u{514D}\u{81EA}\u{5DF1}\u{51ED}\u{7A7A}\u{6784}\u{9020}\u{94FE}\u{63A5}\u{3002}", "parameters": {"properties": {"url": {"type": "string", "description": "\u{76EE}\u{6807}\u{94FE}\u{63A5}\u{FF0C}\u{5E94}\u{8BE5}\u{662F}\u{4E00}\u{4E2A}\u{5B8C}\u{6574}\u{7684}url\u{FF08}\u{4EE5} http \u{5F00}\u{5934}\u{FF09}"}, "description": {"type": "string", "description": "\u{9700}\u{6C42}\u{63CF}\u{8FF0}\u{6587}\u{672C}\u{FF0C}\u{8BE6}\u{7EC6}\u{63CF}\u{8FF0}\u{5728}\u{5F53}\u{524D}url\u{5185}\u{60F3}\u{8981}\u{83B7}\u{53D6}\u{7684}\u{5185}\u{5BB9}"}}, "required": ["url", "description"]}}
{"type": "function", "name": "Search", "parameters": {"type": "object", "properties": {"query": {"type": "string", "description": "\u{641C}\u{7D22}\u{95EE}\u{9898}"}}, "required": ["query"]}, "description": "\u{8FD9}\u{662F}\u{4E00}\u{4E2A}\u{8054}\u{7F51}\u{641C}\u{7D22}\u{5DE5}\u{5177}\u{FF0C}\u{8F93}\u{5165}\u{641C}\u{7D22}\u{95EE}\u{9898}\u{FF0C}\u{8FD4}\u{56DE}\u{7F51}\u{9875}\u{5217}\u{8868}\u{4E0E}\u{5BF9}\u{5E94}\u{7684}\u{6458}\u{8981}\u{4FE1}\u{606F}\u{3002}\u{641C}\u{7D22}\u{95EE}\u{9898}\u{5E94}\u{8BE5}\u{7B80}\u{6D01}\u{6E05}\u{6670}\u{FF0C}\u{590D}\u{6742}\u{95EE}\u{9898}\u{5E94}\u{8BE5}\u{62C6}\u{89E3}\u{6210}\u{591A}\u{6B65}\u{5E76}\u{4E00}\u{6B65}\u{4E00}\u{6B65}\u{641C}\u{7D22}\u{3002}\u{5982}\u{679C}\u{6CA1}\u{6709}\u{641C}\u{7D22}\u{5230}\u{6709}\u{7528}\u{7684}\u{9875}\u{9762}\u{FF0C}\u{53EF}\u{4EE5}\u{8C03}\u{6574}\u{95EE}\u{9898}\u{63CF}\u{8FF0}\u{FF08}\u{5982}\u{51CF}\u{5C11}\u{9650}\u{5B9A}\u{8BCD}\u{3001}\u{66F4}\u{6362}\u{641C}\u{7D22}\u{601D}\u{8DEF}\u{FF09}\u{540E}\u{518D}\u{6B21}\u{641C}\u{7D22}\u{3002}\u{641C}\u{7D22}\u{7ED3}\u{679C}\u{8D28}\u{91CF}\u{548C}\u{8BED}\u{79CD}\u{6709}\u{5173}\u{FF0C}\u{5BF9}\u{4E8E}\u{4E2D}\u{6587}\u{8D44}\u{6E90}\u{53EF}\u{4EE5}\u{5C1D}\u{8BD5}\u{8F93}\u{5165}\u{4E2D}\u{6587}\u{95EE}\u{9898}\u{FF0C}\u{975E}\u{4E2D}\u{8D44}\u{6E90}\u{53EF}\u{4EE5}\u{5C1D}\u{8BD5}\u{4F7F}\u{7528}\u{82F1}\u{6587}\u{6216}\u{5BF9}\u{5E94}\u{8BED}\u{79CD}\u{3002}"}
`;
...
{"type": "function", "name": "JupyterCI", "parameters": {"type": "object", "properties": {"code": {"type": "string", "description": "code"}, "timeout": {"type": "integer", "description": "timeout in seconds"}}, "required": ["code"]}, "description": " JupyterCI \u{4E00}\u{4E2A}\u{4FDD}\u{7559}\u{72B6}\u{6001}\u{7684}\u{4EE3}\u{7801}\u{6C99}\u{76D2}\u{5DE5}\u{5177}\u{3002}\u{4F60}\u{53EF}\u{4EE5}\u{5728}\u{6B64}\u{5DE5}\u{5177}\u{4E2D}\u{8FD0}\u{884C}python\u{4EE3}\u{7801}"}
`;
const gui_functions = `
...
{"type": "function", "name": "wait", "parameters": {"type": "object", "properties": {"time": {"type": "integer", "description": "Wait time in seconds."}}, "required": []}, "description": "Wait for a while."}
`;
const createPROMPT2 = (description)=>`You are an agent designed to accomplish tasks.
${description}
<seed:cot_budget_reflect>${think_budget}</seed:cot_budget_reflect>`;
const PROMPT1 = use_native_thinking ? "" : `You should first think about the reasoning process in the mind and then provide the user with the answer. The reasoning process is enclosed within <${think_token}> </${think_token}> tags, i.e. <${think_token}> reasoning process here </${think_token}> answer here`;
const createPROMPT3 = (functions, additionalNotes)=>`## Function Definition
...
const SYSTEM_PROMPT_GROUP = [
    ...
    createPROMPT3([
        ...
        code_functions,
        gui_functions
    ], omni_additional_notes)
];
const createSystemPromptGroup = (agentMode)=>{
...
export { SYSTEM_PROMPT_GROUP, bypass_native_thinking, code_functions, createSystemPromptGroup, game_functions, gui_functions, mcp_functions, think_token, use_native_thinking };
