...
__webpack_require__.d(__webpack_exports__, {
    ...
    HOME_INSTRUCTION: ()=>HOME_INSTRUCTION,
...
const STOP_INSTRUCTION = `\n
  ...
  `;
const PROXY_INSTRUCTION = "- If you start the service on a port, Do not use port in [8080,8079,8081,8088,8091,8100,8101,8102,8888,9222]. After launch the service, navigate it through a web browser";
const CODE_ENVIRONMENT = `<CODE_ENVIRONMENT>
...
exports.CODE_ENVIRONMENT = __webpack_exports__.CODE_ENVIRONMENT;
exports.HOME_INSTRUCTION = __webpack_exports__.HOME_INSTRUCTION;
exports.PROXY_INSTRUCTION = __webpack_exports__.PROXY_INSTRUCTION;
exports.STOP_INSTRUCTION = __webpack_exports__.STOP_INSTRUCTION;
