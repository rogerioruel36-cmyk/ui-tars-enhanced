 ...
 */
export declare function validateBrowserControlMode(provider: ModelProviderName | string | undefined, requestedMode: BrowserControlMode | undefined, logger: ConsoleLogger): BrowserControlMode;
//# sourceMappingURL=browser-control-validator.d.ts.map