...
exports.modules = {
    "../../node_modules/.pnpm/node-fetch@3.3.2/node_modules/node-fetch/src/utils/multipart-parser.js": function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
        __webpack_require__.d(__webpack_exports__, {
            toFormData: ()=>toFormData
        });
        var fetch_blob_from_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("../../node_modules/.pnpm/fetch-blob@3.2.0/node_modules/fetch-blob/from.js");
        var formdata_polyfill_esm_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("../../node_modules/.pnpm/formdata-polyfill@4.0.10/node_modules/formdata-polyfill/esm.min.js");
        let s = 0;
        const S = {
            START_BOUNDARY: s++,
        ...
        class MultipartParser {
            ...
            write(data) {
                ...
                const callback = (callbackSymbol, start, end, ui8a)=>{
                    if (void 0 === start || start !== end) this[callbackSymbol](ui8a && ui8a.subarray(start, end));
                };
                    ...
                    switch(state){
                        case S.START_BOUNDARY:
                            ...
                            if (index - 1 === boundary.length - 2) {
                                if (flags & F.LAST_BOUNDARY && c === HYPHEN) {
                                    ...
                                    if (flags & F.LAST_BOUNDARY || c !== LF) return;
                                    index = 0;
                        ...
                        case S.PART_DATA:
                            ...
                            if (index < boundary.length) if (boundary[index] === c) {
                                if (0 === index) dataCallback('onPartData', true);
                                index++;
                            } else index = 0;
        ...
        async function toFormData(Body, ct) {
            ...
            const appendFileToFormData = ()=>{
                const file = new fetch_blob_from_js__WEBPACK_IMPORTED_MODULE_0__.$B(entryChunks, filename, {
                    type: contentType
                });
            ...
            parser.onHeaderEnd = function() {
                ...
                if ('content-disposition' === headerField) {
                ...
                } else if ('content-type' === headerField) contentType = headerValue;
                headerValue = '';
                headerField = '';
            };
