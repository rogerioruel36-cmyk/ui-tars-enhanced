...
import { isSupportedActionType } from "@gui-agent/shared/types";
...
class ActionParserHelper {
    ...
    parseCoordinates(params) {
        ...
        const validCoordinates = [
            ...
            x2,
            y2
        ].every((coord)=>lodash_isnumber(coord) && isFinite(coord));
        if (!validCoordinates) {
...
export { ActionParserHelper };

//# sourceMappingURL=ActionParserHelper.mjs.map