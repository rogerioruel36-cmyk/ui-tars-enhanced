...
class AIOHybridOperator extends base_namespaceObject.Operator {
    async initialize() {
                ...
                case 'press':
                    {
                        ...
                        const mappedKeys = keys.map((key)=>external_AIOComputer_js_namespaceObject.keyNameMap[key] || key);
