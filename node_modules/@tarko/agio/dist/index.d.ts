 ...
 */
import { AgentEventStream, ChatCompletionContentPart, ToolCallEngineType } from '@tarko/agent-interface';
export declare namespace AgioEvent {
    /**
     ...
     */
    'agent_initialized' | 'agent_run_start' | 'agent_run_end'
    /**
     ...
     */
     | 'agent_loop_start' | 'agent_loop_end' | 'tool_call' | 'tool_result'
    /**
     ...
     */
    interface AgentInitializedEvent extends BaseEvent {
     ...
     */
    interface TTFTEvent extends BaseEvent {
        type: 'agent_ttft';
        /** Current model name */
        modelName?: string;
     ...
     */
    interface TPSEvent extends BaseEvent {
        type: 'agent_tps';
     ...
     */
    interface LoopStartEvent extends BaseEvent {
     ...
     */
    interface LoopEndEvent extends BaseEvent {
        type: 'agent_loop_end';
        /** Loop iteration number */
        iteration: number;
     ...
     */
    type Event = AgentInitializedEvent | AgentRunStartEvent | AgentRunEndEvent | TTFTEvent | TPSEvent | LoopStartEvent | LoopEndEvent | ToolCallEvent | ToolResultEvent | UserFeedbackEvent;
    /**
     * Event payload type - provides type safety for event creation
     */
    type EventPayload<T extends EventType> = Extract<Event, {
        type: T;
    }>;
    /**
     * AgioProvider - Standard interface for manage Agio events
     */
    interface AgioProvider {
        /**
     ...
     */
    type ExtendedEvent = Event | Extensions[keyof Extensions];
    /**
     * Extended event type union for type guards and filtering
     */
    type ExtendedEventType = EventType | keyof Extensions;
    /**
     * Type-safe payload extraction for extended events
     */
    type ExtendedEventPayload<T extends ExtendedEventType> = T extends EventType ? EventPayload<T> : T extends keyof Extensions ? Extensions[T] : never;
    /**
     ...
     * ```
     */
    function createEvent<T extends ExtendedEventType>(type: T, sessionId: string, payload: Omit<ExtendedEventPayload<T>, 'type' | 'timestamp' | 'sessionId'>): ExtendedEventPayload<T>;
    /**
     ...
     * ```
     */
    function createEvents<T extends ExtendedEventType>(sessionId: string, events: Array<{
        type: T;
     ...
     * ```
     */
    function isEventType<T extends ExtendedEventType>(event: ExtendedEvent, type: T): event is ExtendedEventPayload<T>;
}
