 ...
 */
export declare function isAgentRunObjectOptions(options: AgentRunOptions): options is AgentRunObjectOptions;
/**
 * Type guard to check if options specify streaming mode
 * @param options - The options to check
 * @returns True if streaming mode is enabled
 */
export declare function isStreamingOptions(options: AgentRunObjectOptions): options is AgentRunStreamingOptions;
//# sourceMappingURL=agent-run-options.d.ts.map