import type { ChatCompletionChunk, ChatCompletionContentPart, ChatCompletionMessageParam, ChatCompletionCreateParams, ChatCompletionMessageToolCall, ChatCompletionAssistantMessageParam } from '@tarko/model-provider/types';
 ...
 * @experimental
 */
export declare abstract class ToolCallEngine<T extends StreamProcessingState = StreamProcessingState> {
    /**
 ...
 */
export type ToolCallEngineType = 'native' | 'prompt_engineering' | 'structured_outputs' | TConstructor<ToolCallEngine>;
//# sourceMappingURL=tool-call-engine.d.ts.map