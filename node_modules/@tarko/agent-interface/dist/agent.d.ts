...
import { AgentStatus, LLMRequestHookPayload, LLMResponseHookPayload, LLMStreamingResponseHookPayload, SummaryRequest, SummaryResponse, LoopTerminationCheckResult, PrepareRequestContext, PrepareRequestResult, EachAgentLoopEndContext } from './agent-instance';
import { AgentRunObjectOptions, AgentRunStreamingOptions } from './agent-run-options';
import { ChatCompletionMessageToolCall, OpenAI, ChatCompletionCreateParams, ChatCompletion, RequestOptions, ChatCompletionChunk } from '@tarko/model-provider/types';
...
export interface IAgent<T extends AgentOptions = AgentOptions> {
     ...
     */
    onToolCallError(id: string, toolCall: {
        toolCallId: string;
        name: string;
     ...
     */
    onBeforeLoopTermination(id: string, finalEvent: AgentEventStream.AssistantMessageEvent): Promise<LoopTerminationCheckResult> | LoopTerminationCheckResult;
    /**
     ...
     */
    callLLM(params: Omit<ChatCompletionCreateParams, 'model'> & {
        stream?: false;
    }, options?: RequestOptions): Promise<ChatCompletion>;
    callLLM(params: Omit<ChatCompletionCreateParams, 'model'> & {
        stream: true;
    }, options?: RequestOptions): Promise<AsyncIterable<ChatCompletionChunk>>;
    callLLM(params: Omit<ChatCompletionCreateParams, 'model'>, options?: RequestOptions): Promise<ChatCompletion | AsyncIterable<ChatCompletionChunk>>;
    /**
     ...
     */
    onPrepareRequest(context: PrepareRequestContext): Promise<PrepareRequestResult> | PrepareRequestResult;
}
