import { ChatCompletionContentPart, ChatCompletionMessageToolCall } from '@tarko/model-provider/types';
import { AgentStatus } from './agent-instance';
import { AgentRunObjectOptions } from './agent-run-options';
/**
 ...
 */
export declare namespace AgentEventStream {
    /**
     ...
     */
    'user_message' | 'assistant_message' | 'assistant_thinking_message'
    /**
     * Real-time streaming events - for live updates during agent execution
     */
     | 'assistant_streaming_message' | 'assistant_streaming_thinking_message' | 'assistant_streaming_tool_call'
    /**
     ...
     */
     | 'system' | 'agent_run_start' | 'agent_run_end'
    /**
     * Environment and context events - for external inputs and planning
     */
     | 'environment_input' | 'plan_start' | 'plan_update' | 'plan_finish'
    /**
     * Final output events - for structured final answers and reports
     */
     | 'final_answer' | 'final_answer_streaming';
    /**
     ...
     */
    interface AssistantThinkingMessageEvent extends BaseEvent {
     ...
     */
    interface AssistantStreamingThinkingMessageEvent extends BaseEvent {
     ...
     */
    interface BaseEnvironmentInputMetadata {
     ...
     */
    interface ScreenshotMetadata extends BaseEnvironmentInputMetadata {
        type: 'screenshot';
     ...
     */
    interface TextMetadata extends BaseEnvironmentInputMetadata {
        type: 'text';
    }
    /**
     * Codebase metadata
     */
    interface CodebaseMetadata extends BaseEnvironmentInputMetadata {
        type: 'codebase';
    }
    /**
     * Generic metadata for other types
     */
    interface GenericMetadata extends BaseEnvironmentInputMetadata {
        type: string;
    }
    /**
     * Union type for all environment input metadata types
     */
    type EnvironmentInputMetadata = ScreenshotMetadata | TextMetadata | CodebaseMetadata | GenericMetadata;
    /**
     ...
     */
    interface EnvironmentInputEvent extends BaseEvent {
     ...
     */
    function isScreenshotMetadata(metadata: EnvironmentInputMetadata): metadata is ScreenshotMetadata;
    /**
     * Type guard function to check if an event is an environment input event
     */
    function isEnvironmentInputEvent(event: Event): event is EnvironmentInputEvent;
    /**
     * Type guard function to check if an environment input event has screenshot metadata
     */
    function hasScreenshotMetadata(event: EnvironmentInputEvent): event is EnvironmentInputEvent & {
     ...
     */
    type EventMapping = CoreEventMapping & ExtendedEventMapping;
    /**
     ...
     */
    type Event = EventMapping[EventType];
    /**
     * Event payload type - provides type safety for event creation
     * Now supports extended event types through module augmentation
     */
    type EventPayload<T extends EventType> = T extends keyof EventMapping ? EventMapping[T] : never;
    /**
...
//# sourceMappingURL=agent-event-stream.d.ts.map