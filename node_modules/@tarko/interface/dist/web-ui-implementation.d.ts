 ...
 */
export type AgentWebUIImplementation = StaticAgentWebUIImplementation | RemoteAgentWebUIImplementation;
/**
 * Utility type to extract implementation by type
 */
export type AgentWebUIImplementationByType<T extends AgentWebUIImplementationType> = T extends 'static' ? StaticAgentWebUIImplementation : T extends 'remote' ? RemoteAgentWebUIImplementation : never;
/**
 * Type guard to check if implementation is of specific type
 */
export declare function isAgentWebUIImplementationType<T extends AgentWebUIImplementationType>(implementation: AgentWebUIImplementation, type: T): implementation is AgentWebUIImplementationByType<T>;
//# sourceMappingURL=web-ui-implementation.d.ts.map