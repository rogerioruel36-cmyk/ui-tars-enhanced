 ...
 */
export type AgentStorageImplementation = MemoryAgentStorageImplementation | FileAgentStorageImplementation | SqliteAgentStorageImplementation | DatabaseAgentStorageImplementation | MongoDBAgentStorageImplementation;
/**
 * Utility type to extract implementation by type
 */
export type AgentStorageImplementationByType<T extends AgentStorageImplementationType> = T extends 'memory' ? MemoryAgentStorageImplementation : T extends 'file' ? FileAgentStorageImplementation : T extends 'sqlite' ? SqliteAgentStorageImplementation : T extends 'database' ? DatabaseAgentStorageImplementation : T extends 'mongodb' ? MongoDBAgentStorageImplementation : never;
/**
 * Type guard to check if implementation is of specific type
 */
export declare function isAgentStorageImplementationType<T extends AgentStorageImplementationType>(implementation: AgentStorageImplementation, type: T): implementation is AgentStorageImplementationByType<T>;
