 ...
 */
export type AgentImplementation = ModuleAgentImplementation | ModulePathAgentImplementation | MarkdownAgentImplementation;
/**
 * Utility type to extract implementation by type
 */
export type AgentImplementationByType<T extends AgentImplementationType> = T extends 'module' ? ModuleAgentImplementation : T extends 'modulePath' ? ModulePathAgentImplementation : T extends 'markdown' ? MarkdownAgentImplementation : never;
/**
 * Type guard to check if implementation is of specific type
 */
export declare function isAgentImplementationType<T extends AgentImplementationType>(implementation: AgentImplementation, type: T): implementation is AgentImplementationByType<T>;
/**
...
//# sourceMappingURL=agent-implementation.d.ts.map