...
import { IAgent, AgentEventStream, AgentAppConfig } from '@tarko/interface';
/**
...
export declare class AgioProvider implements AgioEvent.AgioProvider {
    ...
    constructor(providerUrl: string, appConfig: AgentAppConfig, sessionId: string, agent: IAgent);
    /**
