...
class ToolProcessor {
    ...
    getToolSchema(tool) {
        ...
        return (null == (_tool_hasJsonSchema = tool.hasJsonSchema) ? void 0 : _tool_hasJsonSchema.call(tool)) ? tool.schema : (0, index_js_namespaceObject.zodToJsonSchema)(tool.schema);
    }
    constructor(agent, toolManager, eventStream){
        ...
        this.logger = (0, shared_utils_namespaceObject.getLogger)('ToolProcessor');
        this.currentExecutionTools = [];
    }
}
exports.ToolProcessor = __webpack_exports__.ToolProcessor;
