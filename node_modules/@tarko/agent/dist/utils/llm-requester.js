...
const model_provider_namespaceObject = require("@tarko/model-provider");
...
const logger = (0, shared_utils_namespaceObject.getLogger)('LLMRequester');
class LLMRequester {
    async request(options) {
        ...
        const currentModel = (0, model_provider_namespaceObject.resolveModel)(agentModel);
        ...
        const client = (0, index_js_namespaceObject.getLLMClient)(currentModel, {
