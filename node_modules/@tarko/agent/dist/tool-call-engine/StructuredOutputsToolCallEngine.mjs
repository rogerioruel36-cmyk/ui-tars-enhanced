...
class StructuredOutputsToolCallEngine {
    preparePrompt(basePrompt, tools) {
        ...
        const toolsSection = tools.map((tool)=>{
            ...
            const schema = (null == (_tool_hasJsonSchema = tool.hasJsonSchema) ? void 0 : _tool_hasJsonSchema.call(tool)) ? tool.schema : zodToJsonSchema(tool.schema);
            return `
Tool name: ${tool.name}
...
${structuredOutputInstructions}`;
    ...
    constructor(){
        _define_property(this, "logger", getLogger('StructuredOutputsToolCallEngine'));
    }
}
export { StructuredOutputsToolCallEngine };

//# sourceMappingURL=StructuredOutputsToolCallEngine.mjs.map