 ...
 */
export declare function getSessionWorkspaceFiles(req: Request, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
/**
 * Search files and directories in session workspace
 */
export declare function searchWorkspaceItems(req: Request, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
/**
 * Validate if workspace paths exist
 */
export declare function validateWorkspacePaths(req: Request, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
